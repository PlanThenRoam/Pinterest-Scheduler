...
- **TikTok:** 6–8 scenes, playable silent video, cover, caption, five hashtags, sound recommendation, edit/revision, clear and download.
...
- `kind: "tiktok"` with `title`, 6–8 `scenes`, and `videoFile` or `previewFile`.
