...
test('wrong destination, low resolution, mixed fonts, vertical output and protected zones fail',()=>{
 ...
 assert.throws(()=>validateInput({...base,output_type:'pinterest'}),/square/);
