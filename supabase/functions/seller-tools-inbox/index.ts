...
const API_CAPABILITY_VERSION = "4.3.0";
...
const supportedActions=new Set([...masterToolNames,...composerToolNames,'list_etsy_shop_listings','prepare_etsy_listing_update','create_review_project','attach_project_asset','attach_project_asset_from_url','finalize_review_project','list_review_projects','update_review_project','clear_review_project','list_pinterest_boards','prepare_pin_review']);
